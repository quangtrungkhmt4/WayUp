...
public class LevelChartFragment extends Fragment {

    private RequestQueue requestQueue;
    private PieChart pieChart;
    private float[] yData = new float[4];
    private String[] xData = {"Senior", "Junior", "Fresher", "Intent"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_level_chart, container, false);
        findId(view);
        initViews();
        return view;
    }
    private void findId(View view) {
        pieChart = view.findViewById(R.id.chart_level);
    }
    ...
    private void initViews() {
        ...
        desc.setText("Trình độ");
        pieChart.setDescription(desc);
        pieChart.setHoleRadius(45f);
        pieChart.setDrawHoleEnabled(true);
        pieChart.setTransparentCircleAlpha(50);
        pieChart.setCenterText("Trình độ");
    ...
    private void addData() {
        ...
        PieDataSet pieDataSet = new PieDataSet(yEntrys, "Trình độ");
    ...
    private void getQuantum(){
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Preferences.getData(Key.IP, chartActivity) + API.GET_QUANTUM_LEVEL , null, new Response.Listener<JSONObject>() {
            @Override
