...
public class CityChartFragment extends Fragment {

    private RequestQueue requestQueue;
    private PieChart pieChart;
    private float[] yData = new float[3];
    private String[] xData = {"Hà Nội", "Hồ Chí Minh", "Đà Nẵng"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_city_chart, container, false);
        findId(view);
        initViews();
        return view;
    }
    private void findId(View view) {
        pieChart = view.findViewById(R.id.chart_city);
    }
    ...
    private void initViews() {
        ...
        desc.setText("Tỉnh/Thành phố");
        pieChart.setDescription(desc);
        pieChart.setHoleRadius(45f);
        pieChart.setDrawHoleEnabled(true);
        pieChart.setTransparentCircleAlpha(50);
        pieChart.setCenterText("Tỉnh/Thành phố");
    ...
    private void addData() {
        ...
        PieDataSet pieDataSet = new PieDataSet(yEntrys, "Tỉnh/Thành phố");
    ...
    private void getQuantum(){
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, Preferences.getData(Key.IP, chartActivity) + API.GET_QUANTUM_CITY , null, new Response.Listener<JSONObject>() {
            @Override
