package com.example.wayupmanagement.constant;
...
public class API {
    ...
    public static final String SEARCH_USER = "/v1/users/get";
    public static final String GET_LOCK = "/v1/users/lock";
    ...
    public static final String SEARCH_APPLY_VER2 = "/v1/apply/search/";
    ...
    public static final String SEARCH_HR = "/v1/hrs/";

    //vote
    public static final String POST_VOTE = "/v1/votes";
    public static final String SEARCH_VOTE_WITH_USER = "/v1/votes/";
}
